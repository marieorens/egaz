...
class ConfirmDeleteAccountPage extends StatefulWidget {
  const ConfirmDeleteAccountPage({super.key});

  @override
  _ConfirmDeleteAccountPageState createState() => _ConfirmDeleteAccountPageState();
}
...
class _ConfirmDeleteAccountPageState extends State<ConfirmDeleteAccountPage> {
  ...
  Future<void> _deleteAccount() async {
    ...
    if (success) {
      ...
      setState(() {
        _isDeleting = false;
        _errorMessage = "❌ Échec de la suppression du compte. Vérifiez vos informations.";
      });
    }
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildWarningItem('Perte définitive de toutes vos informations et données.'),
            _buildWarningItem('Vous ne pourrez plus accéder à votre compte ou récupérer vos informations.'),
            _buildWarningItem('Toute votre activité associée à ce compte sera supprimée.'),
            const SizedBox(height: 20),
